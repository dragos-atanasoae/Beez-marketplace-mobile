...
export class OrderDetailsPage implements OnInit, OnDestroy {
  ...
  checkOrderStatus(orderStatus: string) {
    switch (orderStatus) {
      case 'PendingToOrder':
        this.iconOrderStatus = './assets/icon/product_states/icon_pending_to_order.svg';
        this.labelOrderStatus = this.translate.instant('pages.marketplace.statusOfOrder.pendingToOrder');
        // this.showToastInfoDelivery();
        break;
      case 'Paid':
        this.iconOrderStatus = this.orderDetails.shippmentInfo.shipmentStatus !== null ? './assets/icon/product_states/icon_ordered.svg' : './assets/icon/product_states/icon_pending_to_order.svg';
        ...
        break;
      case 'Delivered':
        this.iconOrderStatus = './assets/icon/product_states/icon_delivered.svg';
        this.labelOrderStatus = this.translate.instant('pages.marketplace.statusOfOrder.delivered');
        break;
      case 'Cancelled':
        this.iconOrderStatus = './assets/icon/product_states/icon_other_status.svg';
