...
export class RegisterPage implements OnInit {
  ...
  validationMessages = {
    ...
    accept: [
      { type: 'required', message: 'Trebuie să acceptați termenii și condițiile use-beez.com' }
    ],
    confirm_age_over_18: [
      { type: 'required', message: 'We require users to be 18 years old or over!' }
    ]
  };
  ...
  initializeValidationMessages() {
    this.validationMessages = {
      ...
      accept: [
        { type: 'required', message: this.translate.instant('pages.register.validationMessages.agreeRequired') }
      ],
      confirm_age_over_18: [
        { type: 'required', message: 'We require users to be 18 years old or over!'}
      ]
