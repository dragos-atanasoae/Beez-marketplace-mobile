...
import { MarketplaceCategoriesPage } from '../pages/marketplace-categories/marketplace-categories.page';
import { MarketplaceLocationsPage } from '../pages/marketplace-locations/marketplace-locations.page';
import { MarketplaceProductsPage } from '../pages/marketplace-products/marketplace-products.page';
